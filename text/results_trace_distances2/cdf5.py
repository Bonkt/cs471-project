...
inst_line_size = 1024
block_size = 512
filenames = [f"data_caching_i{inst_line_size}_b{block_size}_distance.txt",f"media_streaming_i{inst_line_size}_b{block_size}_distance.txt", f"data_serving_i{inst_line_size}_b{block_size}_distance.txt"]  # Read the three filenames
...
plt.savefig(f"plot/i{inst_line_size}.png")
